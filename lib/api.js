...
export function getBackendUrl() {
  let raw = process.env.BACKEND_URL || process.env.BACKEND_API_URL || process.env.NEXT_PUBLIC_BACKEND_API_URL;
  if (!raw || typeof raw !== 'string' || !raw.trim()) {
    console.warn('[getBackendUrl] Warning: BACKEND_API_URL / NEXT_PUBLIC_BACKEND_API_URL is not defined in .env');
    return '';
  }
